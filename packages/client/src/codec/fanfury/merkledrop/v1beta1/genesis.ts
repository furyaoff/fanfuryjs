...
export interface Indexes {
  $type: 'fanfury.merkledrop.v1beta1.Indexes';
  merkledropId: Long;
  index: Long[];
}

export interface GenesisState {
  $type: 'fanfury.merkledrop.v1beta1.GenesisState';
...
export const Indexes = {
  $type: 'fanfury.merkledrop.v1beta1.Indexes' as const,
  ...
  fromJSON(object: any): Indexes {
    return {
      ...
      index: Array.isArray(object?.index)
        ? object.index.map((e: any) => Long.fromValue(e))
        : [],
    };
  },
...
export const GenesisState = {
  $type: 'fanfury.merkledrop.v1beta1.GenesisState' as const,
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.lastMerkledropId !== undefined &&
      (obj.lastMerkledropId = (
        message.lastMerkledropId || Long.UZERO
      ).toString());
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    const message = createBaseGenesisState();
    message.lastMerkledropId =
      object.lastMerkledropId !== undefined && object.lastMerkledropId !== null
        ? Long.fromValue(object.lastMerkledropId)
        : Long.UZERO;
    message.merkledrops =
