...
export interface Params {
  $type: 'fanfury.merkledrop.v1beta1.Params';
  creationFee?: Coin;
}

function createBaseParams(): Params {
  return { $type: 'fanfury.merkledrop.v1beta1.Params', creationFee: undefined };
}

export const Params = {
  $type: 'fanfury.merkledrop.v1beta1.Params' as const,
