...
export interface EventCreate {
  $type: 'fanfury.merkledrop.v1beta1.EventCreate';
  owner: string;
  merkledropId: Long;
}

export interface EventClaim {
  $type: 'fanfury.merkledrop.v1beta1.EventClaim';
  merkledropId: Long;
  index: Long;
  coin?: Coin;
}
...
export interface EventWithdraw {
  $type: 'fanfury.merkledrop.v1beta1.EventWithdraw';
  merkledropId: Long;
  coin?: Coin;
}
...
export const EventCreate = {
  $type: 'fanfury.merkledrop.v1beta1.EventCreate' as const,
...
export const EventClaim = {
  $type: 'fanfury.merkledrop.v1beta1.EventClaim' as const,
...
export const EventWithdraw = {
  $type: 'fanfury.merkledrop.v1beta1.EventWithdraw' as const,
