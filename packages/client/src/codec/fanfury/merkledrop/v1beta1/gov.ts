...
export interface UpdateFeesProposal {
  $type: 'fanfury.merkledrop.v1beta1.UpdateFeesProposal';
  title: string;
  description: string;
  creationFee?: Coin;
}
...
export interface UpdateFeesProposalWithDeposit {
  $type: 'fanfury.merkledrop.v1beta1.UpdateFeesProposalWithDeposit';
  title: string;
  description: string;
  creationFee: string;
  deposit: string;
...
export const UpdateFeesProposal = {
  $type: 'fanfury.merkledrop.v1beta1.UpdateFeesProposal' as const,
...
export const UpdateFeesProposalWithDeposit = {
  $type: 'fanfury.merkledrop.v1beta1.UpdateFeesProposalWithDeposit' as const,
