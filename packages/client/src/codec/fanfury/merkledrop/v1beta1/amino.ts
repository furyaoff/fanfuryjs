...
export const aminoConverter: { [key: string]: AminoConverter } = {
  '/fanfury.merkledrop.v1beta1.MsgCreate': {
    aminoType: 'go-fanfury/merkledrop/MsgCreate',
    toAmino: ({
      owner,
      merkleRoot,
      startHeight,
  ...
  '/fanfury.merkledrop.v1beta1.MsgClaim': {
    aminoType: 'go-fanfury/merkledrop/MsgClaim',
    toAmino: ({
      sender,
      merkledropId,
      index,
