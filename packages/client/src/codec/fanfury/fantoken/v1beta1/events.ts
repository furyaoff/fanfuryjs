...
export interface EventIssue {
  $type: 'fanfury.fantoken.v1beta1.EventIssue';
  denom: string;
}

export interface EventDisableMint {
  $type: 'fanfury.fantoken.v1beta1.EventDisableMint';
  denom: string;
}

export interface EventMint {
  $type: 'fanfury.fantoken.v1beta1.EventMint';
  recipient: string;
  coin: string;
}

export interface EventBurn {
  $type: 'fanfury.fantoken.v1beta1.EventBurn';
  sender: string;
  coin: string;
}

export interface EventSetAuthority {
  $type: 'fanfury.fantoken.v1beta1.EventSetAuthority';
  denom: string;
  oldAuthority: string;
  newAuthority: string;
}
...
export interface EventSetMinter {
  $type: 'fanfury.fantoken.v1beta1.EventSetMinter';
  denom: string;
  oldMinter: string;
  newMinter: string;
}
...
export interface EventSetUri {
  $type: 'fanfury.fantoken.v1beta1.EventSetUri';
  denom: string;
}

function createBaseEventIssue(): EventIssue {
  return { $type: 'fanfury.fantoken.v1beta1.EventIssue', denom: '' };
}

export const EventIssue = {
  $type: 'fanfury.fantoken.v1beta1.EventIssue' as const,
...
function createBaseEventDisableMint(): EventDisableMint {
  return { $type: 'fanfury.fantoken.v1beta1.EventDisableMint', denom: '' };
}

export const EventDisableMint = {
  $type: 'fanfury.fantoken.v1beta1.EventDisableMint' as const,
...
export const EventMint = {
  $type: 'fanfury.fantoken.v1beta1.EventMint' as const,
...
function createBaseEventBurn(): EventBurn {
  return { $type: 'fanfury.fantoken.v1beta1.EventBurn', sender: '', coin: '' };
}

export const EventBurn = {
  $type: 'fanfury.fantoken.v1beta1.EventBurn' as const,
...
export const EventSetAuthority = {
  $type: 'fanfury.fantoken.v1beta1.EventSetAuthority' as const,
...
export const EventSetMinter = {
  $type: 'fanfury.fantoken.v1beta1.EventSetMinter' as const,
...
function createBaseEventSetUri(): EventSetUri {
  return { $type: 'fanfury.fantoken.v1beta1.EventSetUri', denom: '' };
}

export const EventSetUri = {
  $type: 'fanfury.fantoken.v1beta1.EventSetUri' as const,
