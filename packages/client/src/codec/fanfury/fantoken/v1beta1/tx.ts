...
export const protobufPackage = 'fanfury.fantoken';
...
export interface MsgIssueResponse {
  $type: 'fanfury.fantoken.MsgIssueResponse';
}
...
export interface MsgDisableMintResponse {
  $type: 'fanfury.fantoken.MsgDisableMintResponse';
}
...
export interface MsgMintResponse {
  $type: 'fanfury.fantoken.MsgMintResponse';
}
...
export interface MsgBurnResponse {
  $type: 'fanfury.fantoken.MsgBurnResponse';
}
...
export interface MsgSetMinterResponse {
  $type: 'fanfury.fantoken.MsgSetMinterResponse';
}
...
export interface MsgSetAuthorityResponse {
  $type: 'fanfury.fantoken.MsgSetAuthorityResponse';
}
...
export interface MsgSetUriResponse {
  $type: 'fanfury.fantoken.MsgSetUriResponse';
}
...
export const MsgIssue = {
  $type: 'fanfury.fantoken.MsgIssue' as const,
...
function createBaseMsgIssueResponse(): MsgIssueResponse {
  return { $type: 'fanfury.fantoken.MsgIssueResponse' };
}

export const MsgIssueResponse = {
  $type: 'fanfury.fantoken.MsgIssueResponse' as const,
...
function createBaseMsgDisableMint(): MsgDisableMint {
  return { $type: 'fanfury.fantoken.MsgDisableMint', denom: '', minter: '' };
}

export const MsgDisableMint = {
  $type: 'fanfury.fantoken.MsgDisableMint' as const,
...
function createBaseMsgDisableMintResponse(): MsgDisableMintResponse {
  return { $type: 'fanfury.fantoken.MsgDisableMintResponse' };
}

export const MsgDisableMintResponse = {
  $type: 'fanfury.fantoken.MsgDisableMintResponse' as const,
...
export const MsgMint = {
  $type: 'fanfury.fantoken.MsgMint' as const,
...
function createBaseMsgMintResponse(): MsgMintResponse {
  return { $type: 'fanfury.fantoken.MsgMintResponse' };
}

export const MsgMintResponse = {
  $type: 'fanfury.fantoken.MsgMintResponse' as const,
...
function createBaseMsgBurn(): MsgBurn {
  return { $type: 'fanfury.fantoken.MsgBurn', coin: undefined, sender: '' };
}

export const MsgBurn = {
  $type: 'fanfury.fantoken.MsgBurn' as const,
...
function createBaseMsgBurnResponse(): MsgBurnResponse {
  return { $type: 'fanfury.fantoken.MsgBurnResponse' };
}

export const MsgBurnResponse = {
  $type: 'fanfury.fantoken.MsgBurnResponse' as const,
...
export const MsgSetMinter = {
  $type: 'fanfury.fantoken.MsgSetMinter' as const,
...
function createBaseMsgSetMinterResponse(): MsgSetMinterResponse {
  return { $type: 'fanfury.fantoken.MsgSetMinterResponse' };
}

export const MsgSetMinterResponse = {
  $type: 'fanfury.fantoken.MsgSetMinterResponse' as const,
...
export const MsgSetAuthority = {
  $type: 'fanfury.fantoken.MsgSetAuthority' as const,
...
function createBaseMsgSetAuthorityResponse(): MsgSetAuthorityResponse {
  return { $type: 'fanfury.fantoken.MsgSetAuthorityResponse' };
}

export const MsgSetAuthorityResponse = {
  $type: 'fanfury.fantoken.MsgSetAuthorityResponse' as const,
...
export const MsgSetUri = {
  $type: 'fanfury.fantoken.MsgSetUri' as const,
...
function createBaseMsgSetUriResponse(): MsgSetUriResponse {
  return { $type: 'fanfury.fantoken.MsgSetUriResponse' };
}

export const MsgSetUriResponse = {
  $type: 'fanfury.fantoken.MsgSetUriResponse' as const,
...
export class MsgClientImpl implements Msg {
  ...
  Issue(request: MsgIssue): Promise<MsgIssueResponse> {
    ...
    const promise = this.rpc.request('fanfury.fantoken.Msg', 'Issue', data);
    return promise.then(data => MsgIssueResponse.decode(new _m0.Reader(data)));
  }

  Mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request('fanfury.fantoken.Msg', 'Mint', data);
    return promise.then(data => MsgMintResponse.decode(new _m0.Reader(data)));
  }

  Burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request('fanfury.fantoken.Msg', 'Burn', data);
  ...
  SetMinter(request: MsgSetMinter): Promise<MsgSetMinterResponse> {
    ...
    const promise = this.rpc.request('fanfury.fantoken.Msg', 'SetMinter', data);
    return promise.then(data =>
  ...
  SetUri(request: MsgSetUri): Promise<MsgSetUriResponse> {
    ...
    const promise = this.rpc.request('fanfury.fantoken.Msg', 'SetUri', data);
