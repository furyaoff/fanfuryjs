...
export interface QueryFanTokensResponse {
  $type: 'fanfury.fantoken.v1beta1.QueryFanTokensResponse';
  fantokens: FanToken[];
...
export interface QueryParamsRequest {
  $type: 'fanfury.fantoken.v1beta1.QueryParamsRequest';
}

/** QueryParametersResponse is response type for the Query/Parameters RPC method */
export interface QueryParamsResponse {
  $type: 'fanfury.fantoken.v1beta1.QueryParamsResponse';
  params?: Params;
}

function createBaseQueryFanTokenRequest(): QueryFanTokenRequest {
  return { $type: 'fanfury.fantoken.v1beta1.QueryFanTokenRequest', denom: '' };
}

export const QueryFanTokenRequest = {
  $type: 'fanfury.fantoken.v1beta1.QueryFanTokenRequest' as const,
...
export const QueryFanTokenResponse = {
  $type: 'fanfury.fantoken.v1beta1.QueryFanTokenResponse' as const,
...
export const QueryFanTokensRequest = {
  $type: 'fanfury.fantoken.v1beta1.QueryFanTokensRequest' as const,
...
export const QueryFanTokensResponse = {
  $type: 'fanfury.fantoken.v1beta1.QueryFanTokensResponse' as const,
...
function createBaseQueryParamsRequest(): QueryParamsRequest {
  return { $type: 'fanfury.fantoken.v1beta1.QueryParamsRequest' };
}

export const QueryParamsRequest = {
  $type: 'fanfury.fantoken.v1beta1.QueryParamsRequest' as const,
...
export const QueryParamsResponse = {
  $type: 'fanfury.fantoken.v1beta1.QueryParamsResponse' as const,
...
export class QueryClientImpl implements Query {
  ...
  FanToken(request: QueryFanTokenRequest): Promise<QueryFanTokenResponse> {
    ...
    const promise = this.rpc.request(
      'fanfury.fantoken.v1beta1.Query',
      'FanToken',
      data,
    );
