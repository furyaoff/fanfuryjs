...
export interface Metadata {
  $type: 'fanfury.fantoken.v1beta1.Metadata';
...
export interface FanToken {
  $type: 'fanfury.fantoken.v1beta1.FanToken';
...
export const Metadata = {
  $type: 'fanfury.fantoken.v1beta1.Metadata' as const,
...
export const FanToken = {
  $type: 'fanfury.fantoken.v1beta1.FanToken' as const,
