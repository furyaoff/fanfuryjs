...
import { Account } from '@fanfuryjs/utils';
import {
...
const TEST_ADDRESS="fanfury1dhqmhaksj5qw4ays64pp9mff3fwkxtugvn0at5"
const OTHER_TEST_ADDRESS="fanfury1s0aj6f7hgzr3gfcmm9xz0lg0442qdq9su9llq0"
const RPC_NODE_URL="https://rpc.nft-devnet.fanfury.network/"
...
const connect = async (mnemonic?: string) => {
  ...
  return new FanfuryClient<typeof modules>({
    connection: {
      type: 'tendermint',
